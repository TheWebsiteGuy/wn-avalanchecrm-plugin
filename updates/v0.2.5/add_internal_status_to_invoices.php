...
return new class extends Migration {
    public function up()
    {
        if (Schema::hasColumn('thewebsiteguy_nexuscrm_invoices', 'internal_status')) {
            return;
        }
        ...
        //    - 'draft'     → internal_status='draft',  status='outstanding'
        //    - 'sent'      → internal_status='sent',   status='outstanding'
        //    - 'paid'      → internal_status='sent',   status='paid'
        //    - 'cancelled' → internal_status='sent',   status='cancelled'
        DB::table('thewebsiteguy_nexuscrm_invoices')
            ->where('status', 'draft')
