...
return new class extends Migration {
    public function up()
    {
        if (!Schema::hasColumn('thewebsiteguy_avalanchecrm_subscription_plans', 'stripe_price_id')) {
            Schema::table('thewebsiteguy_avalanchecrm_subscription_plans', function (Blueprint $table) {
                $table->string('stripe_price_id')->nullable()->after('paypal_plan_id');
            });
        }

        if (!Schema::hasColumn('thewebsiteguy_avalanchecrm_clients', 'stripe_customer_id')) {
        ...
        if (!Schema::hasColumn('thewebsiteguy_avalanchecrm_subscriptions', 'stripe_subscription_id')) {
