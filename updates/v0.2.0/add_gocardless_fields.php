...
class AddGoCardlessFields extends Migration
{
    public function up()
    {
        ...
        if (!Schema::hasColumn('thewebsiteguy_nexuscrm_clients', 'gocardless_customer_id')) {
        ...
        if (!Schema::hasColumn('thewebsiteguy_nexuscrm_subscriptions', 'gocardless_subscription_id')) {
